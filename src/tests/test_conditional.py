...
def big(l):
    return [(12345678901234567891234567890123456789 * x, 12345678901234567891234567890123456789 * y) for (x, y) in l]


def small(l):
    return [(x / 12345678901234567891234567890123456789, y / 12345678901234567891234567890123456789) for (x, y) in l]
