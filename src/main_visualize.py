...
def parse_arguments():
    ...
    parser.add_argument("-d", "--delaunay", action='store_true', help="draw Delaunay triangulation")
    parser.add_argument("-v", "--voronoi", action='store_true', help="draw Voronoi diagram")
    parser.add_argument("-c", "--circumcircles", action='store_true', help="draw circumcircles")
...
def main(args):
    ...
    if c:
        drawer.add_circles(circles, edgecolor="red", facecolor="none", linewidths=0.75, alpha=0.5)
    drawer.show()
